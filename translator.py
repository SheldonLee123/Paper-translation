                ...
                if (isinstance(x, LTTextBoxHorizontal)):
                    with open(txt_path, 'a') as f:
                        ...
                        if len(results) > 10:
                            ...
                            if results.count(" ") < int(len(results)/3):
                                trans_res = trans(results)
                                f.write(results + "\n\n")
                                f.write(trans_res + "\n\n")
...
if __name__ == '__main__':
    pdf_path = '/Users/lixiangyu/Documents/Leeds-PhD/1604.03670.pdf'
    txt_path = '/Users/lixiangyu/Documents/Python/test.txt'
    f = open(txt_path, "w")
